...
import { convertToMatrix, extractLetters, validateCharUniquenes } from "./string";

function findStart(matrix: Array<string[]>): IPointInfo
{
...
function goToNext(matrix: Array<string[]>,  path: IPointInfo[]): void
{
